...
template <typename T>
String CreateSimpleMessage(const String& type, const String& id, const String& subject, const String& name, T value)
{
...
String CreateSimpleMessage(const String& type, const String& id, const String& subject)
{
  DynamicJsonDocument doc(512);
  auto root = doc.to<JsonObject>();
  auto header = root.createNestedObject("header");
