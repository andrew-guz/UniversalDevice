...
UniversalDeviceSimulator::UniversalDeviceSimulator() :
    ...
    values{ std::map<std::string, UniversalData>{
        ...
        { "param_string", UniversalData{ "test" } },
    } } {}
...
void UniversalDeviceSimulator::SendValues() {
    ...
    values._values.at("param_int") = std::get<int>(values._values.at("param_int")) + int_distribution(random_generator);
    values._values.at("param_double") = std::get<double>(values._values.at("param_double")) + double_distribution(random_generator);
